const { 
    ...
    LURE_LIST_FAIL, 
    LURE_LIST_REQUEST, 
    LURE_LIST_SUCCESS } = require('../constant/lureConstant')

export const lureListReducer = (
    state = {loading: true, lures:[]},
    action) => {
...
export const lureDetailsReducer = (
    state = { lure: {}, loading: true}, 
    action) => {
